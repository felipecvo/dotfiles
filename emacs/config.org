...
- [[#ui-configuration][UI Configuration]]
  ...
  - [[#configuração-de-emojis-para-windows][Configuração de Emojis para Windows]]
  - [[#modeline][Modeline]]
...
#+begin_src emacs-lisp
  (use-package org-modern
    ...
    (set-face-attribute 'org-modern-symbol nil :family "Segoe UI Symbol"))
